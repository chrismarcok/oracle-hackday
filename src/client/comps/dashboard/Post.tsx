...
export const PostComp: React.FC<PostCompProps> = ({ post, large }) => {
  ...
  return (
    <div
      className="postcomp-outermost"
      style={{ height: large ? "fit-content" : "250px" }}
    >
      ...
      <div className="mid-col post-col">
        <div className="mid-col-inner">
          ...
          <p
            className="mid-col-body"
            dangerouslySetInnerHTML={{ __html: markdown.toHTML(post.body) }}
          ></p>
        </div>
        {!large && (
          <p
        ...
        <div
          style={{ fontSize: "0.8rem", position: "absolute", right: "-99px" }}
        >
